...
import { AppState, EntryCategory, LetterPaperStyle, Mood } from "../types/domain";
...
const validEntryCategories: EntryCategory[] = ["work", "relationships", "love", "family", "dream", "taste", "habit", "health", "other"];
